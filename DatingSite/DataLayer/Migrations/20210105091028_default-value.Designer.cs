...
namespace DataLayer.Migrations
{
    ...
    [Migration("20210105091028_default-value")]
            ...
            modelBuilder.Entity("DataLayer.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReceiverId = 1,
                            SenderId = 2,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 185, DateTimeKind.Local).AddTicks(4628)
                        },
                        new
                        {
                            MessageId = 2,
                            ...
                            ReceiverId = 3,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 187, DateTimeKind.Local).AddTicks(1878)
                        },
                        new
                        {
                            MessageId = 3,
                            ...
                            ReceiverId = 2,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 187, DateTimeKind.Local).AddTicks(1905)
                        });
                });
            ...
            modelBuilder.Entity("DataLayer.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReceiverId = 1,
                            SenderId = 2,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 187, DateTimeKind.Local).AddTicks(9077)
                        },
                        new
                        {
                            PostId = 2,
                            ...
                            ReceiverId = 2,
                            SenderId = 3,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 187, DateTimeKind.Local).AddTicks(9398)
                        },
                        new
                        {
                            PostId = 3,
                            ...
                            ReceiverId = 3,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 187, DateTimeKind.Local).AddTicks(9409)
                        });
                });
            ...
            modelBuilder.Entity("DataLayer.Models.Visit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReceiverId = 1,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 188, DateTimeKind.Local).AddTicks(1465)
                        },
                        new
                        {
                            VisitId = 2,
                            ReceiverId = 2,
                            SenderId = 3,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 188, DateTimeKind.Local).AddTicks(2046)
                        },
                        new
                        {
                            VisitId = 3,
                            ReceiverId = 3,
                            SenderId = 2,
                            TimeStamp = new DateTime(2021, 1, 5, 10, 10, 28, 188, DateTimeKind.Local).AddTicks(2056)
                        });
                });

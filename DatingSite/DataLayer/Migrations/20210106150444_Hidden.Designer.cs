...
namespace DataLayer.Migrations
{
    ...
    [Migration("20210106150444_Hidden")]
            ...
            modelBuilder.Entity("DataLayer.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReceiverId = 1,
                            SenderId = 2,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 171, DateTimeKind.Local).AddTicks(5369)
                        },
                        new
                        {
                            MessageId = 2,
                            ...
                            ReceiverId = 3,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 173, DateTimeKind.Local).AddTicks(2620)
                        },
                        new
                        {
                            MessageId = 3,
                            ...
                            ReceiverId = 2,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 173, DateTimeKind.Local).AddTicks(2645)
                        });
                });
            ...
            modelBuilder.Entity("DataLayer.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReceiverId = 1,
                            SenderId = 2,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 173, DateTimeKind.Local).AddTicks(9640)
                        },
                        new
                        {
                            PostId = 2,
                            ...
                            ReceiverId = 2,
                            SenderId = 3,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 173, DateTimeKind.Local).AddTicks(9961)
                        },
                        new
                        {
                            PostId = 3,
                            ...
                            ReceiverId = 3,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 173, DateTimeKind.Local).AddTicks(9972)
                        });
                });
            ...
            modelBuilder.Entity("DataLayer.Models.Visit", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ReceiverId = 1,
                            SenderId = 1,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 174, DateTimeKind.Local).AddTicks(1966)
                        },
                        new
                        {
                            VisitId = 2,
                            ReceiverId = 2,
                            SenderId = 3,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 174, DateTimeKind.Local).AddTicks(2530)
                        },
                        new
                        {
                            VisitId = 3,
                            ReceiverId = 3,
                            SenderId = 2,
                            TimeStamp = new DateTime(2021, 1, 6, 16, 4, 44, 174, DateTimeKind.Local).AddTicks(2541)
                        });
                });

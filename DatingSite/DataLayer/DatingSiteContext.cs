    ...
    public class DatingSiteContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(
                new User() { UserId = 1, NationalityId = 1, PersonalityId = 1,NickName="Pandrum", FirstName = "Simon", LastName = "Bernsdorff Wallstedt", Mail = "simon.bernsdorff-wallstedt@dating.com", Age = 28, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar1.png" },
                new User() { UserId = 2, NationalityId = 1, PersonalityId = 2,NickName="brollestar", FirstName = "Lukas", LastName = "Brolin", Mail = "lukas.brolin@dating.com", Age = 27, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar2.png" },
                new User() { UserId = 3, NationalityId = 1, PersonalityId = 3,NickName="paraplydricka", FirstName = "Filip", LastName = "Johansson", Mail = "filip.johansson@dating.com", Age = 27, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar3.png" },
                new User() { UserId = 4, NationalityId = 1, PersonalityId = 4,NickName="magge", FirstName = "Magnus", LastName = "Fredriksson", Mail = "magnus.fredriksson@dating.com", Age = 34, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar4.png" },
                new User() { UserId = 5, NationalityId = 2, PersonalityId = 2,NickName="didhje", FirstName = "Didrik", LastName = "Hjelm", Mail = "didrik.hjelm@dating.com", Age = 22, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar5.png" },
                new User() { UserId = 6, NationalityId = 2, PersonalityId = 5,NickName="Selma", FirstName = "Selma", LastName = "Nordheim", Mail = "selma.nordheim@dating.com", Age = 25, Online = false, Gender = "Female", Active = true, ImgUrl = "~/img/avatars/avatar2.png" },
                new User() { UserId = 7, NationalityId = 1, PersonalityId = 1,NickName="Kassi", FirstName = "Kassandra", LastName = "Lökholm", Mail = "kassandra.Lökholm@dating.com", Age = 27, Online = false, Gender = "Female", Active = true, ImgUrl = "~/img/avatars/avatar3.png" },
                new User() { UserId = 8, NationalityId = 1, PersonalityId = 5,NickName="Kentaflenta", FirstName = "Kent", LastName = "Andersson", Mail = "kent.andersson@dating.com", Age = 31, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar4.png" },
                new User() { UserId = 9, NationalityId = 4, PersonalityId = 3,NickName="Vettelmano", FirstName = "Sebastian", LastName = "Vettel", Mail = "sebastian.vettel@dating.com", Age = 41, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar5.png" },
                new User() { UserId = 10, NationalityId = 4, PersonalityId = 3,NickName="Spyking", FirstName = "Nico", LastName = "Rosberg", Mail = "nico.rosberg@dating.com", Age = 38, Online = false, Gender = "Male", Active = true, ImgUrl = "~/img/avatars/avatar2.png" },
                new User() { UserId = 11, NationalityId = 5, PersonalityId = 4,NickName="Hermione", FirstName = "Emma", LastName = "Watson", Mail = "emma.watson@dating.com", Age = 30, Online = false, Gender = "Female", Active = true, ImgUrl = "~/img/avatars/avatar1.png" });
        }
    }
}